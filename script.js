...
const T = {
  en: {
    ...
    sk3_d: "DLT for financial assets, DREX/CBDC, smart contracts, programmable money.",
  ...
  pt: {
    ...
    sk3_d: "DLT para ativos financeiros, DREX/CBDC, contratos inteligentes, dinheiro programável.",
